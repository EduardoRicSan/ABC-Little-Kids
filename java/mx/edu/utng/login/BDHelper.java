...
public class BDHelper extends SQLiteOpenHelper {
    ...
    public static final String TAG = BDHelper.class.getSimpleName();

    public static final String DB_NAME= "guarderia.db";
     ...
     */
    public void addUser(String name, String gender,String password){
